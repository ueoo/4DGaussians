    ...
    def forward(
        ...
        if time_emb is None:
            ...
            return self.forward_dynamic(
                rays_pts_emb, scales_emb, rotations_emb, opacity, shs_emb, time_feature, time_emb
            )
...
class deform_network(nn.Module):
    def __init__(self, args):
        ...
        self.timenet = nn.Sequential(
            nn.Linear(times_ch, timenet_width), nn.ReLU(), nn.Linear(timenet_width, timenet_output)
        )
